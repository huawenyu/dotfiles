...
" Integration {{{2
    ...
    Plug 'wlemuel/vim-tldr',                 Cond(Mode(['editor',]))    | " :Tldr <linux-cmd>
    Plug 'alok/notational-fzf-vim',          Cond(Mode(['editor',]))    | " :NV <text> Grep 'text' then fzf-preview from multiple dirs
